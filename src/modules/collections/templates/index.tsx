...
export default async function CollectionTemplate({
  ...
  return (
    <>
      <div className="max-md:mt-18 relative aspect-[2/1] w-full max-w-full mb-8 md:mb-19 md:h-[500px] lg:h-[600px] overflow-hidden">
        <Image
          src={
          ...
          <Layout className="mb-26 md:mb-36">
            {collectionDetails.data.collection_page_heading && (
              <LayoutColumn start={1} end={{ base: 13, lg: 7 }}>
                <h5 className="text-md max-md:mb-6 md:text-2xl">
                  {collectionDetails.data.collection_page_heading}
                </h5>
              </LayoutColumn>
            )}
