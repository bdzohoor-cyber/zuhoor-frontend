          ...
          <div className="flex max-lg:flex-col justify-between md:gap-20 max-md:px-4">
            <div className="flex flex-1 max-lg:w-full max-lg:order-2 max-sm:flex-col justify-between sm:gap-30 lg:gap-20 md:items-start">
              <div className="max-w-40 md:flex-1 max-md:mb-12">
                <h1 className="text-xl md:text-2xl mb-3 md:mb-8 leading-tight font-normal tracking-tight">
                  Zuhoor
                </h1>
              ...
              <div className="flex gap-12 xl:gap-20 max-md:text-xs flex-1 justify-between lg:justify-center">
                ...
                <ul className="flex flex-col gap-5 md:gap-4">
                  ...
                  <li>
                    <a
                      href="https://www.instagram.com/zuhoor_official_/"
                      target="_blank"
                  ...
                  <li>
                    <a href="https://www.tiktok.com/@zuhoorlife" target="_blank" rel="noopener noreferrer" className="text-sm hover:text-gray-300 transition-colors">
                      TikTok
                    </a>
                  </li>
                  <li>
                    <a href="https://www.facebook.com/ZuhoorBD" target="_blank" rel="noopener noreferrer" className="text-sm hover:text-gray-300 transition-colors">
                      Facebook
                    </a>
                  </li>
                </ul>
